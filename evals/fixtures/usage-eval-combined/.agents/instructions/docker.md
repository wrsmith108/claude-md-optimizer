---
description: "Docker service ports (API: 3742, PostgreSQL: 5499, Redis: 6380), first-time setup with docker compose, native module rebuild, hot-reload troubleshooting"
