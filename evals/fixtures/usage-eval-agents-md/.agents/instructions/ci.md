---
description: "CI pipeline: lint, typecheck, test, integration checks (all required); 3 approving reviews required; linear history enforced; 22-minute total timeout"
